...
r7kamura.comドメインの運用に必要な金額は、以下のように変化しました。

- 年間20.44USD (≒2,912円) ← Route53時代
- 年間08.03USD (≒1,142円) ← Cloudflare時代
...
Route 53のドメインの更新は、.comドメインの場合は年額13USD課金されます。
...
Cloudflareの場合、年額8.03USD (≒1,142円) 課金される見込みです。課金される要素はドメインの更新のみで、.comドメインの場合は年額8.03USDです。
